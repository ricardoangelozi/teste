...
/**
 * The persistent class for the boleto_premiado database table.
 * 
 */
@Entity
@Table(name="boleto_premiado")
@NamedQuery(name="BoletoPremiado.findAll", query="SELECT b FROM BoletoPremiado b")
public class BoletoPremiado implements Serializable {
